...
\paragraph{Stroke length.}Guided by the workspace analysis in \cite{StewartPlatformWorkspace}, we prioritize achieving the necessary vertical range of motion, knowing that sufficient 
horizontal range would follow. Assuming a minimum actuator mounting angle of at least 45° to the horizontal, the minimum required stroke length is calculated as:
\begin{equation}
...
Next, we designed the upper and lower jaws, which are attached to the platform and base respectively. 
...
and positioned slightly forward to leave room for a future tongue module. 
...
The final robot design has a total mass of approximately 21 kg, with a bounding box measuring 530 mm in length, 460 mm in width, and 600 mm in height.
The center of mass is located roughly 150 mm above the middle of the base, low enough to ensure stability during operation.
