...
In our case, the center of rotation is the gnathion, defined as a fixed point ${\bf c}$, rather than the origin of the platform. Therefore, 
...
\begin{figure}[H]
\centering
\includegraphics[width=0.6\textwidth]{figures/load_cells_axis.drawio.png}
